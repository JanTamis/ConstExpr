...
internal static partial class RegexCaseEquivalences
{
	...
	/// This method, in contrast to <see cref="TryFindCaseEquivalencesForChar(char, out ReadOnlySpan{T})"/> does take in
	...
	private static bool TryFindCaseEquivalencesForChar(char c, out ReadOnlySpan<char> equivalences)
	{
		...
		var index = (byte) ((uint) c / CharactersPerRange);
		var firstLevelLookupValue = EquivalenceFirstLevelLookup[index];
		...
		var index2 = (ushort) ((uint) c % CharactersPerRange + firstLevelLookupValue);
		var mappingValue = EquivalenceCasingMap[index2];
		...
		var count = (byte) (mappingValue >> 13 & 0b111);
		var index3 = (ushort) (mappingValue & 0x1FFF);
