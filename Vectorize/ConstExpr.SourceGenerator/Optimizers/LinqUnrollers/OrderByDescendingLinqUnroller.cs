...
/// <summary>
/// Unrolls <c>.OrderByDescending(keySelector)</c> as an intermediate step.
...
/// </summary>
public class OrderByDescendingLinqUnroller : BaseLinqUnroller
{
	private const string BufferName = "orderByDescBuffer";
	...
	public override void UnrollAboveLoop(UnrolledLinqMethod method, List<StatementSyntax> statements)
	{
		...
		// var orderByDescBuffer = new List<T>();
	...
	public override void UnrollAfterMainLoop(UnrolledLinqMethod method, IList<StatementSyntax> partialLoopBody, List<StatementSyntax> resultStatements)
	{
		...
		// orderByDescBuffer.Sort((a, b) => keySelector(b).CompareTo(keySelector(a)));
		// Note: reversed order (b, a) for descending
		var paramA = "sortA";
		var paramB = "sortB";
		...
		// Descending: compare keyB to keyA
		...
		// foreach (var item in orderByDescBuffer) { <partialLoopBody> }
