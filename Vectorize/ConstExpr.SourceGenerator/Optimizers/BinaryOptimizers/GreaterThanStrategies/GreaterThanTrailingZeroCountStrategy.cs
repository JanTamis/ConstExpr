...
/// </summary>
public class GreaterThanTrailingZeroCountStrategy : BaseBinaryStrategy
{
	...
	public override bool TryOptimize(BinaryOptimizeContext<ExpressionSyntax, ExpressionSyntax> context, out ExpressionSyntax? optimized)
	{
		...
		// count < 0 is a tautology and count + 1 >= the bit width means x == 0; both are left to other passes
