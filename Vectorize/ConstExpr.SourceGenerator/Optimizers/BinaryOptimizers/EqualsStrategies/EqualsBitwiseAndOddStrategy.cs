...
/// </summary>
public class EqualsBitwiseAndOddStrategy : SymmetricStrategy<NumericBinaryStrategy>
{
	...
	{
		if (context.Left.Syntax is not BinaryExpressionSyntax	{ RawKind: (int)SyntaxKind.BitwiseAndExpression } andExpr)
		{
			return null;
		}
