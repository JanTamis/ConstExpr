...
public abstract class SymmetricStrategy<TLeft, TRight>(SyntaxKind leftKind = SyntaxKind.None, SyntaxKind rightKind = SyntaxKind.None) : BaseBinaryStrategy<ExpressionSyntax, ExpressionSyntax>
	where TLeft : ExpressionSyntax
	where TRight : ExpressionSyntax
{
	public override bool TryOptimize(BinaryOptimizeContext<ExpressionSyntax, ExpressionSyntax> context, out ExpressionSyntax? optimized)
