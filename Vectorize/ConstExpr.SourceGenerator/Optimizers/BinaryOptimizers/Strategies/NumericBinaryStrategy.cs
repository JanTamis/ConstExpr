...
public class NumericBinaryStrategy<TLeft, TRight> : SpecialTypeBinaryStrategy<TLeft, TRight>
...
public class NumericBinaryStrategy : NumericBinaryStrategy<ExpressionSyntax, ExpressionSyntax>;