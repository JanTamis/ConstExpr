...
public class BinaryNotEqualsOptimizer : BaseBinaryOptimizer
{
	...
	public override IEnumerable<IBinaryStrategy> GetStrategies()
	{
		...
		yield return new NotEqualsModuloPowerOfTwoZeroStrategy();
		yield return new NotEqualsBitwiseAndOddStrategy();
		yield return new NotEqualsBitwiseAndEvenStrategy();
		yield return new NotEqualsRightShiftZeroStrategy();
		yield return new NotEqualsExclusiveOrZeroStrategy();
		yield return new NotEqualsPopCountStrategy();
		...
		yield return new NotEqualsIntegerIsolationStrategy();
		yield return new NotEqualsReciprocalIsolationStrategy();
	}
}