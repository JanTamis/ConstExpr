...
/// </summary>
public class NotEqualsModuloPowerOfTwoZeroStrategy() : SymmetricStrategy<IntegerBinaryStrategy, BinaryExpressionSyntax, LiteralExpressionSyntax>(leftKind: SyntaxKind.ModuloExpression)
{
