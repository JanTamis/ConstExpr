...
public class NotEqualsToUpperStrategy : SymmetricStrategy<InvocationExpressionSyntax, InvocationExpressionSyntax>
{
	public override bool TryOptimizeSymmetric(BinaryOptimizeContext<InvocationExpressionSyntax, InvocationExpressionSyntax> context, out ExpressionSyntax? optimized)
	{
		if (context.Left.Syntax.ArgumentList.Arguments.Count != 1
		    ...
		    || context.Left.Syntax.Expression is not MemberAccessExpressionSyntax { Name: IdentifierNameSyntax { Identifier.Text: "ToUpper" } }
		    || context.Right.Syntax.Expression is not MemberAccessExpressionSyntax { Name: IdentifierNameSyntax { Identifier.Text: "ToUpper" } }
