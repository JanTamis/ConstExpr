...
[InheritsTests]
public class IsValidEmailTest() : BaseTest<Func<string, bool>>(FastMathFlags.FastMath, optimizations: OptimizationFlags.CommonSubexpressionElimination | OptimizationFlags.TailRecursionElimination)
{
