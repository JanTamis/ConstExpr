...
/// </summary>
[InheritsTests]
public class IsAsciiHexDigitTest() : BaseTest<Func<char, bool>>(FastMathFlags.FastMath, optimizations: OptimizationFlags.CommonSubexpressionElimination | OptimizationFlags.TailRecursionElimination)
{
