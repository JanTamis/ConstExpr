...
[InheritsTests]
public class IsInRangeTest() : BaseTest<Func<int, int, int, bool>>(FastMathFlags.All, optimizations: OptimizationFlags.CommonSubexpressionElimination | OptimizationFlags.TailRecursionElimination)
{
