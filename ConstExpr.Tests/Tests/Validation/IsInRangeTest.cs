...
[InheritsTests]
public class IsInRangeTest() : BaseTest<Func<int, int, int, bool>>(FastMathFlags.FastMath, optimizations: OptimizationFlags.CommonSubexpressionElimination | OptimizationFlags.TailRecursionElimination)
{
