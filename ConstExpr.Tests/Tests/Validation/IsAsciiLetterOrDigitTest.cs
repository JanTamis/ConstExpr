...
/// </summary>
[InheritsTests]
public class IsAsciiLetterOrDigitTest() : BaseTest<Func<char, bool>>(FastMathFlags.FastMath | FastMathFlags.CommonSubexpressionElimination | FastMathFlags.TailRecursionElimination)
{
