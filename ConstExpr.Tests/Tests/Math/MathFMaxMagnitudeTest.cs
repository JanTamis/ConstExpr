...
[InheritsTests]
public class MathFMaxMagnitudeTest() : BaseTest<Func<float, float, float>>(FastMathFlags.FastMath, optimizations: OptimizationFlags.CommonSubexpressionElimination | OptimizationFlags.TailRecursionElimination)
{
