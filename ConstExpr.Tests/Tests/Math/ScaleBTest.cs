...
[InheritsTests]
public class ScaleBTest() : BaseTest<Func<double, int, double>>(FastMathFlags.FastMath | FastMathFlags.CommonSubexpressionElimination | FastMathFlags.TailRecursionElimination)
{
