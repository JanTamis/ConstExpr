...
[InheritsTests]
public class CommonSubexpressionNameCollisionTest() : BaseTestWithRandomValues<Func<int, int, int>>(optimizations: OptimizationFlags.CommonSubexpressionElimination)
{
