...
public class RGBToYCbCrTest() : BaseTest<Func<byte, byte, byte, (double, double, double)>>(FastMathFlags.FastMath)
{
	...
	[
		Create("""
			...
			return (Double.MultiplyAddEstimate(0.1145, fb, Double.MultiplyAddEstimate(0.2989, fr, fg * 0.5866)), Double.MultiplyAddEstimate(0.5, fb, Double.MultiplyAddEstimate(-0.3313, fg, -(fr * 0.1687))), Double.MultiplyAddEstimate(-0.0816, fb, Double.MultiplyAddEstimate(0.5, fr, -(fg * 0.4184))));
			"""),
	];
}