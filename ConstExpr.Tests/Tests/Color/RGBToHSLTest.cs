...
[InheritsTests]
public class RGBToHSLTest() : BaseTest<Func<byte, byte, byte, (int, double, double)>>(FastMathFlags.FastMath | FastMathFlags.CommonSubexpressionElimination | FastMathFlags.TailRecursionElimination)
{
