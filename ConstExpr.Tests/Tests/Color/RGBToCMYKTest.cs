...
[InheritsTests]
public class RGBToCMYKTest() : BaseTest<Func<byte, byte, byte, (double, double, double, double)>>(FastMathFlags.FastMath | FastMathFlags.CommonSubexpressionElimination | FastMathFlags.TailRecursionElimination)
{
