...
[InheritsTests]
public class RGBToYUVTest() : BaseTest<Func<byte, byte, byte, (double, double, double)>>(FastMathFlags.FastMath, optimizations: OptimizationFlags.CommonSubexpressionElimination | OptimizationFlags.TailRecursionElimination)
{
